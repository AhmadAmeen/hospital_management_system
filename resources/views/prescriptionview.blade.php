<link rel="stylesheet" type="text/css" href="{{ asset('public/css/prescription-css.css') }}" />
  ...
  <div class="prescription">
   ...
   <tr>
    ...
    <td>10 days</td>
        ...
        <tr>
          <td colspan="5"><p style="margin-left:14px;font-size:6px">Before food (Don’t take the tab, I say)</p></td></tr>
                 <tr>
    <td>4.</td>
    <td>Oil</td>
    <td>Brufen</td>
